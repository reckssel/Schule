...
class gui:
    ...
    def button_click(self):
        ...
        # 👉 Zweites Fenster öffnen und Werte übergeben
    ...
    def open_second_window(self, name, spalten):
        ...
        for i in range(spalten):
            ...
            dropdown = tk.OptionMenu(self.second, var, "TEXT", "INTEGER", "REAL")
